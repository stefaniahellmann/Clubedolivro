...
export function Dashboard() {
  ...
  const quickLinks = [
    ...
    },
    {
      ...
      description: 'Ouça nossos episódios semanais',
      icon: Headphones,
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {quickLinks.map((link, index) => (
          <Card key={index} hover className="group cursor-pointer bg-gray-800/50 backdrop-blur-sm border-gray-600">
            <a
              href={link.url}
              target="_blank"
            ...
            >
              <div className="text-center space-y-3">
                <div className={`bg-gradient-to-br ${link.color} p-4 rounded-xl group-hover:scale-110 transition-transform shadow-lg mx-auto w-fit`}>
